#include "slambot_controllers/simple_controller.hpp"
                                  ...
                                  , theta_(0.0)
{
    ...
    declare_parameter("wheel_separation", 0.235);
    ...
    vel_sub_ = create_subscription<geometry_msgs::msg::Twist>("/slambot_controllers/cmd_vel_unstamped", 10, std::bind(&SimpleController::velCallback, this, _1));
    ...
    odom_pub_ = create_publisher<nav_msgs::msg::Odometry>("/slambot_controllers/odom", 10);
